...
ActiveRecord::Schema.define(version: 2023_02_01_020430) do
ActiveRecord::Schema.define(version: 2023_01_06_042728) do
  ...
  create_table "activities", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.string "employee_ids", default: [], array: true
    t.date "startdate"
    t.string "time"
    t.bigint "project_id"
